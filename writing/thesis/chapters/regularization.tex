...
Following the principle of \emph{Occam's razor}---parsimonious models are better---all regularization methods penalize complexity.
...
Tikhonov regularization assumes that all weights are distributed with the same variance.
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=0.6\textwidth]{diagonal}
...
\begin{figure}[hbt]
  \centering
  \makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{path_lasso}}%
  \caption{Regularization path for the lasso}\label{fig:path-lasso}
\end{figure}
\sidetitle{Lasso path}
\Cref{fig:path-lasso} shows the path for the lasso, which first integrates the bias, then one \(x_4\) point, then
...
\begin{figure}[H]
  \centering
  \makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{path_grp}}%
...
\begin{figure}[H]
  \centering
  \makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{path_en}}%
...
\begin{figure}[p]
  \begin{subfigure}[t]{0.5\textwidth}
    \centering
    \includegraphics[width=0.9\textheight, angle =-90 ]{heatmap_lasso}
    \caption{Lasso}
  \end{subfigure}~
  \begin{subfigure}[t]{0.5\textwidth}
    \centering
    \includegraphics[width=0.9\textheight, angle =-90]{heatmap_grp}
    \caption{Group Lasso}
  \end{subfigure}
